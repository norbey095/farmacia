...
public class Purchases {
    ...
    public Purchases(int id, int code, String product_name, int purchase_amount, double purchase_prace, double purchase_subtotal, double total, String created, String supplier_name_product, String purcharser) {
        this.id = id;
        this.code = code;
        this.product_name = product_name;
        this.purchase_amount = purchase_amount;
        this.purchase_prace = purchase_prace;
    ...
    public double getPurchase_prace() {
        return purchase_prace;
    }

    public void setPurchase_prace(double purchase_prace) {
        this.purchase_prace = purchase_prace;
    }
